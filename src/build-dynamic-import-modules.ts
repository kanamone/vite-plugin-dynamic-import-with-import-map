...
export type BuildDynamicImportModules = (modules: ReadonlyArray<Module>, distPath: string) => Promise<Result<ReadonlyArray<ImportMapEntry>, BuildDynamicImportModulesError>>

export const buildDynamicImportModules: (deps: Dependencies) => BuildDynamicImportModules = (deps) => async (mods, distPath) => {
  ...
  return createOk(transformedModsResult.val.map(mod => {
